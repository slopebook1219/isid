                        ...
                        <table class="min-w-full divide-y divide-gray-200 table-fixed select-none">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="w-1/5 px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    </th>
                                </tr>
                            </thead>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($questions as $question)
                                    <tr id="question-row-{{ $question->id }}">
                                        ...
                                        <td id="question-text-{{ $question->id }}" class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 truncate">
                                            {{ $question->text }}
                                        </td>
                                        
                                        <td id="question-unit-{{ $question->id }}" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            {{ $question->unit }}
                                        </td>
                            ...
                            <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white"
                                ...
                                <div class="mt-4">
                                    ...
                                    ">
                                        @csrf
                                        <div class="mb-4">
                                            <label for="editText" class="block font-medium text-sm text-gray-700">問題文</label>
                                            <input type="text" id="editText" x-model="editingQuestion.text" required
                                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                        </div>
                                        <div class="mb-4">
                                            <label for="editUnit" class="block font-medium text-sm text-gray-700">単位</label>
